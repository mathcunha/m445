...
public class TwoLayerPerceptron {
	...
	protected Logger log = Logger.getLogger(TwoLayerPerceptron.class.getName());

	public TwoLayerPerceptron(double minWeight, double maxWeight) {
	...
	public static TwoLayerPerceptron getMultilayerPerceptronSinalBipolar(
		...
		TwoLayerPerceptron retorno = new TwoLayerPerceptron(minWeight, maxWeight);
	...
	public void backprop(int max_it, double min_error, double alfa,
		...
		TwoLayerPerceptron lMultilayerPerceptron = getMultilayerPerceptronSinalBipolar(
